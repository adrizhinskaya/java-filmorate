...
//        genres.add(genre1);
//        Film film = new Film(1, "film1", "description1", LocalDate.of(1990, 1, 1), 101, mpa, genres);
//
//        FilmDbRepository filmDbRepository = new FilmDbRepository(jdbcTemplate);
//        filmDbRepository.addAndReturnId(film);
//        genres.clear();
//        genres.add(genre2);
//        Film newFilm = new Film(1, "film2", "description2", LocalDate.of(1990, 1, 2), 102, mpa, genres);
...
//        Collection<Genre> genres = new ArrayList<>();
//        genres.add(genre1);
//        Film film1 = new Film(1, "film1", "description1", LocalDate.of(1990, 1, 1), 101, mpa, genres);
//        Film film2 = new Film(2, "film2", "description2", LocalDate.of(1990, 1, 2), 102, mpa, genres);
//
//        FilmDbRepository filmDbRepository = new FilmDbRepository(jdbcTemplate);
