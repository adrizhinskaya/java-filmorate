...
class UserDbRepositoryTest {
    ...
    public void testGetUserById() {
        ...
        User newUser = new User(1, "user@email.ru", "Newvanya123", "NewIvan Petrov",
                LocalDate.of(1990, 1, 1));
    ...
    public void testGetUsers() {
        User user1 = new User(1, "user1@email.ru", "vanya1", "Ivan Petrov1",
                LocalDate.of(1990, 1, 1));
        User user2 = new User(2, "user2@email.ru", "vanya2", "Ivan Petrov2",
    ...
    public void testGetCommonFriends() {
        ...
        User user2 = new User(2, "user2@email.ru", "vanya2", "Ivan Petrov2",
                LocalDate.of(1990, 1, 2));
        User user3 = new User(3, "user3@email.ru", "vanya3", "Ivan Petrov3",
